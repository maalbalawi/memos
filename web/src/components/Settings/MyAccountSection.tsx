  ...
  return (
    <div className="w-full gap-2 pt-2 pb-4">
      ...
      <div className="w-full mt-2 flex flex-row justify-start items-center">
        <UserAvatar className="m-2 shrink-0 w-10 h-10" avatarUrl={user.avatarUrl} />
        <div className="max-w-[calc(100%-3rem)] flex flex-col justify-center items-start">
          <p className="w-full">
            ...
            <span className="mr-1 text-base leading-tight text-muted-foreground">({user.username})</span>
          </p>
      ...
      <div className="w-full flex flex-row justify-start items-center mt-2 space-x-2">
        <Button variant="outline" onClick={handleEditAccount}>
          <PenLineIcon className="w-4 h-4 mx-auto ml-1" />
          {t("common.edit")}
        </Button>
        <DropdownMenu>
