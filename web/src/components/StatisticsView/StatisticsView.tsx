    ...
    <div className="group w-full mt-2 space-y-1 text-muted-foreground animate-fade-in">
      ...
      <div className="pt-1 w-full flex flex-row justify-start items-center gap-1 flex-wrap">
        {isRootPath && hasPinnedMemos && (
          <StatCard
            icon={<BookmarkIcon className="w-4 h-auto ml-1 opacity-70" />}
        ...
        <StatCard
          icon={<LinkIcon className="w-4 h-auto ml-1 opacity-70" />}
          label={t("memo.links")}
        ...
        <StatCard
          icon={
            memoTypeStats.undoCount > 0 ? (
              <ListTodoIcon className="w-4 h-auto ml-1 opacity-70" />
            ) : (
              <CheckCircleIcon className="w-4 h-auto ml-1 opacity-70" />
            )
          }
          label={t("memo.to-do")}
          count={
        ...
        <StatCard
          icon={<Code2Icon className="w-4 h-auto ml-1 opacity-70" />}
          label={t("memo.code")}
